...
function testContentReceive() {
    int udpPort = 48827;
    udp:Client socketClient = new ({port: udpPort});
...
function testContentReceiveWithLength() {
    ...
    udp:Client socketClient = new ({host: "localhost", port: udpPort});
    string returnStr = "";
...
public function startUdpServer() returns udp:Error? = @java:Method {
    'class: "org/ballerinalang/stdlib/udp/testutils/MockServerUtils"
} external;

public function stopUdpServer() returns udp:Error? = @java:Method {
    'class: "org/ballerinalang/stdlib/udp/testutils/MockServerUtils"
} external;

public function passUdpContent(string content, int port) returns udp:Error? = @java:Method {
    'class: "org/ballerinalang/stdlib/udp/testutils/MockServerUtils"
} external;
